...
export class AboutPageComponent {
  tiles = [
    ...
    { text: 'Hi, my name is Bryan Hernandez-Trejo and I\'m from Nashville, TN. I\'m a passionate computer science student currently enrolled as a Senior at Middle Tennessee State University. I\'ve been working at Plutus for 6 months and it has been an amazing experience. We have enjoyed working alongside them in the process of web development and learning new technologies.', image: '/assets/Images/bryanPic.jpg' },
    { text: 'My name is Andrew Preston, I am an experienced software engineer pursuing a Master’s degree in Computer Science. I am proficient in a variety of programming languages and technologies, including .NET, Angular, Molecular JS, micro service architecture, and Kubernetes. Leveraging these technologies I enable companies to streamline their operations, enhance productivity, and deliver cutting edge solutions.', image: '/assets/Images/AndrewPic.jpg' }
  ];
}
